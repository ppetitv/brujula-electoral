document.addEventListener('DOMContentLoaded', function () {
    ...
    function startChatSequence(userQuery, isPreloaded = false) {
        ...
        const messages = ["Verificando fuentes de RPP...", "Construyendo respuesta...", "Potenciando esta consulta gracias a Marca Patrocinadora", "Potenciando esta consulta gracias a Marca Patrocinadora", "Potenciando esta consulta gracias a Marca Patrocinadora", "Potenciando esta consulta gracias a Marca Patrocinadora"];
        let messageIndex = 0;
        if (preloaderText) {
